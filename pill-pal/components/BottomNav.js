...
const BottomNav = ({navigation, style}) =>{
        return (
            ...
            <TouchableOpacity style = {[styles.bottomNavIcon, {backgroundColor: "rgba(0,0,0,.0)", alignItems:"center", justifyContent:"center", }]}><LogoSVG height = {50} style = {{top: -5, right: -3.4}} /></TouchableOpacity>
